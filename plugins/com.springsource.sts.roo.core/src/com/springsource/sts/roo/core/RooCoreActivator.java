 ...
 ******************************************************************************************/
package com.springsource.sts.roo.core;
...
import com.springsource.sts.roo.core.model.RooInstallManager;
...
public class RooCoreActivator extends AbstractUIPlugin {
	...
	// The plug-in ID
	public static final String PLUGIN_ID = "com.springsource.sts.roo.core";

	public static String NATURE_ID = PLUGIN_ID + ".nature";
