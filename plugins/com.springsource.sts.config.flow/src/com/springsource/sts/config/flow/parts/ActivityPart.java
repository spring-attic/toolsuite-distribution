...
import com.springsource.sts.config.flow.model.AbstractGefFlowModelElement;
...
public abstract class ActivityPart extends AbstractGraphicalEditPart implements PropertyChangeListener, NodeEditPart {
	...
	public void propertyChange(PropertyChangeEvent evt) {
		...
		if (AbstractGefFlowModelElement.CHILDREN.equals(prop)) {
			refreshChildren();
		}
		else if (AbstractGefFlowModelElement.INCOMINGS.equals(prop)) {
			refreshTargetConnections();
		}
		else if (AbstractGefFlowModelElement.OUTGOINGS.equals(prop)) {
