...
public abstract class AbstractConfigFlowDiagram extends ParallelActivity {
	...
	public AbstractConfigFlowDiagram(AbstractConfigGraphicalEditor editor) {
		super();
		this.editor = editor;
