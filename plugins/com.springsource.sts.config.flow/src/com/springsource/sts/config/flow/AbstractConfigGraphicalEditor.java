...
import com.springsource.sts.config.core.IConfigEditorPage;
...
import com.springsource.sts.config.flow.actions.ResetManualLayoutAction;
import com.springsource.sts.config.flow.actions.ShowPropertiesAction;
import com.springsource.sts.config.flow.actions.ShowSourceAction;
...
public abstract class AbstractConfigGraphicalEditor extends GraphicalEditorWithPalette implements IConfigEditorPage {
	...
	protected abstract AbstractConfigFlowDiagram createFlowDiagram();
