...
public abstract class ActivityDiagramPart extends StructuredActivityPart implements IPropertyChangeListener {
	...
	public ActivityDiagramPart(AbstractConfigFlowDiagram diagram, int direction) {
		super(diagram);
	...
	/**
	 * @see com.springsource.sts.config.flow.parts.ActivityPart#activate()
	 */
	@Override
	...
	/**
	 * @see com.springsource.sts.config.flow.parts.ActivityPart#deactivate()
	 */
	@Override
	...
	@Override
	public void refresh() {
		((AbstractConfigFlowDiagram) getModelElement()).refreshModelFromXml();
		super.refresh();
	}
